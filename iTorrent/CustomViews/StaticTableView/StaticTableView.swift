...
extension StaticTableView : UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        return presentableData[section].headerFunc?() ?? Localize.get(presentableData[section].header)
    }
    
    func tableView(_ tableView: UITableView, titleForFooterInSection section: Int) -> String? {
        return presentableData[section].footerFunc?() ?? Localize.get(presentableData[section].footer)
    }
