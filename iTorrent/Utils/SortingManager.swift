...
class SortingManager {
    ...
    public static func createSortingController(buttonItem: UIBarButtonItem? = nil, applyChanges: @escaping () -> () = {
    ...
    private static func createAlertButton(_ buttonName: String, _ sortingType: SortingTypes, _ applyChanges: @escaping () -> () = {
    }) -> UIAlertAction {
    ...
    private static func createSectionsAlertButton(_ applyChanges: @escaping () -> () = {
    }) -> UIAlertAction {
