...
class PatreonService {
    ...
    private static let campaignID = "3344001"
    private static let clientID = "3SM5Qyfl2F48XvT1T6ukBrcxacBuzQhGRvPAoGYnOA2RkLaW8Pa9xFP43xUFKOdU"
    private static let clientSecret = "ID5vnz2vr0ZrZhmsUg1EbC9hTXPsVD4RBskXMxuhqGJy5xDytflXVNOSMfOrDF5H"
...
//        }
        ...
        var components = URLComponents(string: "/api/oauth2/v2/campaigns/\(Self.campaignID)/members")!
...
//        }
        ...
        let body = "code=\(encodedOauthCode)&grant_type=authorization_code&client_id=\(Self.clientID)&client_secret=\(Self.clientSecret)&redirect_uri=\(Self.redirectUri)"
