...
class UserPreferences {
    ...
    static let webDavUsername = SettingProperty<String>("webDavUsername", "")
    static let webDavPassword = SettingProperty<String>("webDavPassword", "")
    static let webDavWebServerEnabled = SettingProperty<Bool>("webDavWebServerEnabled", true)
    static let webDavWebDavServerEnabled = SettingProperty<Bool>("webDavWebDavServerEnabled", false)
