...
//import UIKit
//
//class TorrentFilesControllerOld: ThemedUIViewController {
...
//    var downloadedFiles: [FileModel] {
//        showFiles.filter { $0.downloadedBytes == $0.size }
//    }
//
...
//
//    func initialize() {
//        guard let localFiles = TorrentSdk.getFilesOfTorrentByHash(hash: managerHash) else {
//            dismiss(animated: false)
//            return
//        }
//
//        files.append(contentsOf: localFiles)
//
//        if let file = localFiles.first, root == "", file.path.starts(with: self.name + "/") {
//            root = self.name
//        }
//        
...
//        }
//        for file in files {
//            if file.size != 0, file.downloadedBytes / file.size == 1 {
...
//        }
//        TorrentSdk.setTorrentFilesPriority(hash: managerHash, states: res)
//    }
//
//    @IBAction func selectButtonItem(_ sender: UIBarButtonItem) {
//        var indexPaths = [IndexPath]()
//        for iter in 0..<showFiles.count {
//            if showFiles[iter].downloadedBytes != showFiles[iter].size {
...
//
//    @objc func shareAll() {
//        print(Core.rootFolder + "/" + root)
//        var path: NSURL
//        if root.isEmpty {
//            if let file = showFiles.first {
//                path = NSURL(fileURLWithPath: Core.rootFolder + "/" + file.path + "/" + file.name, isDirectory: false)
//            } else {
//                return
//            }
//        } else {
//            path = NSURL(fileURLWithPath: Core.rootFolder + "/" + root, isDirectory: true)
//        }
...
//                paths.append(NSURL(fileURLWithPath: Core.rootFolder + "/" + root + "/" + showFolders[key]!.name, isDirectory: true))
//            } else {
//                let index = indexPath.row - showFolders.keys.count
//                paths.append(NSURL(fileURLWithPath: Core.rootFolder + "/" + downloadedFiles[index].path + "/" + downloadedFiles[index].name, isDirectory: false))
//            }
//        }
...
//                    cell.hideUI = true
//                    cell.update()
//                    cell.switcher.setOn(downloadedFiles[index].priority != .dontDownload, animated: false)
//                    cell.actionDelegate = self
//                    return cell
//                }
//            }
...
//                let file = self.showFiles[indexPath.row - self.showFolders.count]
//                file.priority = .normalPriority
